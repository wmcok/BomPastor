Public NotInheritable Class frmTelaSplash
    ...
    Private Sub frmTelaSplash_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Copyright.Text = My.Application.Info.CompanyName & " - " & String.Format("Versão {0}", My.Application.Info.Version.ToString)
    End Sub
